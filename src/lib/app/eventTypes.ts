...
export type AppEvent =
	| {name: 'LoginAccount'; params: LoginAccountParams}
	| {name: 'LogoutAccount'; params: LogoutAccountParams}
	| {name: 'CreateCommunity'; params: CreateCommunityParams}
	| {name: 'ReadCommunity'; params: ReadCommunityParams}
	| {name: 'ReadCommunities'; params: ReadCommunitiesParams}
	| {name: 'UpdateCommunitySettings'; params: UpdateCommunitySettingsParams}
	| {name: 'DeleteCommunity'; params: DeleteCommunityParams}
	| {name: 'CreateAccountPersona'; params: CreateAccountPersonaParams}
	| {name: 'ReadPersona'; params: ReadPersonaParams}
	| {name: 'CreateMembership'; params: CreateMembershipParams}
	| {name: 'DeleteMembership'; params: DeleteMembershipParams}
	| {name: 'CreateSpace'; params: CreateSpaceParams}
	| {name: 'ReadSpace'; params: ReadSpaceParams}
	| {name: 'ReadSpaces'; params: ReadSpacesParams}
	| {name: 'UpdateSpace'; params: UpdateSpaceParams}
	| {name: 'DeleteSpace'; params: DeleteSpaceParams}
	| {name: 'CreateEntity'; params: CreateEntityParams}
	| {name: 'UpdateEntity'; params: UpdateEntityParams}
	| {name: 'ReadEntities'; params: ReadEntitiesParams}
	| {name: 'ReadEntitiesPaginated'; params: ReadEntitiesPaginatedParams}
	| {name: 'QueryEntities'; params: QueryEntitiesParams}
	| {name: 'EraseEntity'; params: EraseEntityParams}
	| {name: 'DeleteEntities'; params: DeleteEntitiesParams}
	| {name: 'CreateTie'; params: CreateTieParams}
	| {name: 'ReadTies'; params: ReadTiesParams}
	| {name: 'DeleteTie'; params: DeleteTieParams}
	| {name: 'Ping'; params: PingParams}
	| {name: 'ToggleMainNav'; params: ToggleMainNavParams}
	| {name: 'ToggleSecondaryNav'; params: ToggleSecondaryNavParams}
	| {name: 'SetMobile'; params: SetMobileParams}
	| {name: 'OpenDialog'; params: OpenDialogParams}
	| {name: 'CloseDialog'; params: CloseDialogParams}
	| {name: 'SelectPersona'; params: SelectPersonaParams}
	| {name: 'SelectCommunity'; params: SelectCommunityParams}
	| {name: 'SelectSpace'; params: SelectSpaceParams}
	| {name: 'ViewSpace'; params: ViewSpaceParams};
