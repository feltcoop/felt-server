...
<ContextmenuSubmenu>
	<svelte:fragment slot="entry">
		<span class="menu-item-entry"><UnicodeIcon icon="☉" /><span class="content">Entity</span></span>
	</svelte:fragment>
	<svelte:fragment slot="menu">
		...
		>
			<span class="content">Edit Entity</span>
		</ContextmenuEntry>
