...
export const STORE_SUBSCRIBER_COUNT = Symbol('store_subscriber_count');
...
export function readable<T>(value?: T, start?: StartStopNotifier<T>): Readable<T> {
	...
	return {subscribe: s.subscribe, get: s.get, [STORE_SUBSCRIBER_COUNT]: s[STORE_SUBSCRIBER_COUNT]};
}
...
export function derived<T>(stores: Stores, fn: Function, initial_value?: T): Readable<T> {
	...
	return {
		...
		get: () => (s[STORE_SUBSCRIBER_COUNT]() === 0 ? get_store_value(s) : s.get()),
