...
import type {CreatePersonaParamsType, create_persona_response_type} from '$lib/ui/events';
import {create_persona} from '$lib/vocab/persona/persona.events';

//Creates a new persona
export const createPersonaService: Service<CreatePersonaParamsType, create_persona_response_type> =
	{
